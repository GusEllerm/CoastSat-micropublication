...
<body>
    <div class="header">
        ...
        <p>Interactive Research Publication for Transect $TRANSECT_ID</p>
    </div>
    
    <div class="cards">
        <div class="card">
            <h2>📊 Dynamic Micropublication</h2>
            <p>
    ...
    <div class="footer">
        <p>
            Generated by <strong>CoastSat Micropublication System</strong><br>
            Part of the CoastSat coastal monitoring initiative
        </p>
    </div>
</body>
</html>
